...
public class CheckCodeUtil extends HttpServlet{
	...
	public static void outputImage(int w, int h, OutputStream os, String code) throws IOException{
		...
		for(int i = 0; i < checkSize; i++){
			...
			affine.setToRotation(Math.PI / 4 * rand.nextDouble() * (rand.nextBoolean() ? 1 : -1), (w / checkSize) * i + fontSize/2, h/2);
			g2.setTransform(affine);
			g2.drawChars(chars, i, 1, ((w-10) / checkSize) * i + 5, h/2 + fontSize/2 - 10);
		}
	...
	public static void main(String[] args) throws IOException{
		File dir = new File("C:\\Users\\cyh\\Desktop");
		int w = 200, h = 80;
		for(int i = 0; i < 3; i++){
