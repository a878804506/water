...
public interface BillService {
    ...
    List<Bill> getAllBills(CustomerPage cp); // 查询所有用户起止码
     ...
     * 获取今日录入水费的用户数
     */
    int getSectionNum(String startDate,String endDate);

    /**
     *按 limit 获取今日录入用户的详情
     */
    List<TransitionModel> getToDayDatasList(String startDate,String endDate,String limit);
}
